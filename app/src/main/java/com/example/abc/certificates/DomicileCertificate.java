...
public class DomicileCertificate extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent intent=new Intent(Cetificate.this, DomicileCertificate);
                ...
                Toast.makeText(DomicileCertificate.this, "Your Certificate is Generated", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
